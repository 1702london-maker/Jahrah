  ...
  async rewrites() {
    return {
      beforeFiles: [
        ...
        { source: '/host/dashboard', destination: '/stitch/host-dashboard.html' },
        ...
        { source: '/privacy', destination: '/stitch/privacy.html' },
        { source: '/terms', destination: '/stitch/terms.html' },
        { source: '/cookies', destination: '/stitch/cookies.html' },
      ],
    }
  },
}
